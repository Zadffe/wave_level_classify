...
def train(args):
    ...
    model = seresnet18(num_classes=len(class_names)).to(device)
    ...
    #     logging.info(f"{name}: requires_grad={param.requires_grad}, shape={param.shape}")
