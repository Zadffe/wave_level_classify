...
class SEResNet(nn.Module):
    ...
    def __init__(self, block, block_num, class_num=3, in_channels=1):
        super().__init__()
...
def seresnet18(class_num=3, in_channels=1):
    return SEResNet(BasicResidualSEBlock, [2, 2, 2, 2], class_num=class_num, in_channels=in_channels)
